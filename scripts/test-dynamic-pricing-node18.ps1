# Download Node.js 18
Invoke-WebRequest -Uri "https://nodejs.org/dist/v18.18.2/node-v18.18.2-x64.msi" -OutFile "node18.msi"

# Install Node.js 18
Start-Process msiexec.exe -Wait -ArgumentList "/i node18.msi /quiet"
